# backend/quantum_ai_optimizer/pipeline/preprocess.py
...
# EEG / MRI loaders
from quantum_ai_optimizer.datasets.eeg_loader import (
    load_sample_eeg,  # alias for PhysioNet auto-fetch
    preprocess_eeg,
)
from quantum_ai_optimizer.datasets.mri_loader import (
