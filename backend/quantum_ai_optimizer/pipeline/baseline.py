# backend/quantum_ai_optimizer/pipeline/baseline.py
import json
from pathlib import Path

from quantum_ai_optimizer.utils.logger import (
    create_run_folder,
    save_metrics,
    save_text_log,
)
...
try:
    from quantum_ai_optimizer.datasets.eeg_loader import load_sample_eeg as load_physionet_eeg
except ImportError:
    # If your loader exposes load_physionet_eeg already, import it directly
    from quantum_ai_optimizer.datasets.eeg_loader import load_physionet_eeg

from quantum_ai_optimizer.datasets.eeg_loader import preprocess_eeg
